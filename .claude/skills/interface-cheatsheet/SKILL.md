---
name: interface-cheatsheet
description: Practical interface design guidance for UI details, animation, typography, colors, accessibility, layout, and UX writing. Use when building or reviewing web interfaces and you need concise, actionable quality checks.
---
